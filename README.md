...
http://localhost:18444/realms/dummyrealm/.well-known/openid-configuration

http://localhost:18444/realms/dummyrealm/protocol/openid-connect/certs

curl -X POST http://localhost:18444/realms/dummyrealm/protocol/openid-connect/token

curl -X POST -d "client_id=tokie" -d "grant_type=password" -d "username=tokie" -d "password=Dummy_123" http://localhost:18444/realms/dummyrealm/protocol/openid-connect/token
